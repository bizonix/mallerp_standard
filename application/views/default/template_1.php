...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="utf-8" lang="utf-8">
    <head>
        ...
        <style type='text/css' media='all'>@import url('<?php echo base_url(); ?>static/css/nav/dropdown.css');</style>
        ...
        <script type="text/javascript" src="<?php echo base_url(); ?>static/js/nav/dropdown.js"></script>
