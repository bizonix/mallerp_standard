...
class MY_EbaySession
{
	...
	*/
    ...
    public function __construct($config)
	{
		...
		$this->devID = $config['developerID'];
		$this->appID = $config['applicationID'];
		$this->certID = $config['certificateID'];
		$this->compatLevel = $config['compatabilityLevel'];
		$this->siteID = $config['siteToUseID'];
		$this->verb = $config['callName'];
