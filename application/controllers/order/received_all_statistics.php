...
class Received_all_statistics extends Order
{
    public $cur_rates;
    ...
    public function by_country_and_region()
    {
       ...
       $status_id = fetch_status_id('order_status', 'received_full_refunded');
      ...
      $data = array(
       ...
       $this->template->write_view('content','order/receive_full_refunded/by_country_and_region',$data);
    ...
    public function by_shipping_way()
    {
       ...
       $this->template->write_view('content','order/receive_full_refunded/by_shipping_way',$data);
       $this->template->render();
    ...
    public function by_input_account()
    {
     ...
     $this->template->write_view('content', 'order/receive_full_refunded/by_input_account', $data);
     $this->template->add_js('static/js/sorttable.js');
     $this->template->render();
    }
    ...
    public function by_ship_confirm_user()
    {
       ...
       $this->template->write_view('content','order/receive_full_refunded/by_ship_confirm_user',$data);
       $this->template->render();
    }
    ...
    public function by_sku()
    {
      ...
      $this->template->write_view('content','order/receive_full_refunded/by_sku',$data);
      $this->template->add_js('static/js/sorttable.js');
      $this->template->render();
    }
}
