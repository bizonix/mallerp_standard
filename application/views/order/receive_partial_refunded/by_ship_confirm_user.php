...
foreach ($ship_users as  $ship_user)
{
	...
	$return_currency.= empty($return_cost[$ship_user]['EUR'])? "0.00 EUR<br>" : $return_cost[$ship_user]['EUR']."EUR<br>";
...
$sortable[] = 'integer';
$sortable[] = 'integer';
$title = lang('received_partial_refunded_statistics')."-".lang('by_ship_confirm_user');
