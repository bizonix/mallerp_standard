...
foreach ($ship_codes as  $ship_code)
{
	...
	$return_currency.= empty($return_cost[$ship_code]['EUR'])? "0.00 EUR<br>" : $return_cost[$ship_code]['EUR']."EUR<br>";
...
$sortable[] = 'integer';
$sortable[] = 'integer';
$title = lang('received_partial_refunded_statistics')."-".lang('by_shipping_way');
