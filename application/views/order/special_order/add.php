...
$data[] = array(
    $this->block->generate_required_mark(lang('state_province')),
    form_input($config),
);
...
$commit_button = lang('confirm_again');

$url = site_url('order/special_order/save_again');
$config = array(
    'name'        => 'submit',
    'value'       => $commit_button,
    'type'        => 'button',
...
//echo form_hidden('old_item_no', $order->item_no);
