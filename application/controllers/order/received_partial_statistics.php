...
class Received_partial_statistics extends Order
{
    public $cur_rates;
    ...
    public function by_country_and_region()
    {
     ...
     $this->template->write_view('content', 'order/receive_partial_refunded/by_country_and_region', $data);
     $this->template->add_js('static/js/sorttable.js');
    ...
    public function by_shipping_way()
    {
       ...
       $this->template->write_view('content','order/receive_partial_refunded/by_shipping_way',$data);
       $this->template->render();
    ...
    public function by_input_account()
    {
     ...
     $this->template->write_view('content', 'order/receive_partial_refunded/by_input_account', $data);
     $this->template->add_js('static/js/sorttable.js');
     $this->template->render();
    }
