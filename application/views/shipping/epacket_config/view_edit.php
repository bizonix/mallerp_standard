...
$data[] = array(
    ...
    form_dropdown('user_id', $options, $epacket_config->user_id),
);
...
$data[] = array(
    ...
    form_dropdown('stock_code', $options,$epacket_config->stock_code),
);
...
$data[] = array(
    ...
    form_dropdown('is_register', $options, $epacket_config->is_register),
);
$options = array();
...
$data[] = array(
    ...
    form_dropdown('pagesize', $options, $epacket_config->pagesize),
);
...
$data[] = array(
    ...
    form_dropdown('emspickuptype', $options, $epacket_config->emspickuptype),
);
...
$config = array(
    ...
    'maxlength'   => '128',
    'size'        => '60',
	'value'		  => $epacket_config->pickupaddress_company,
);
$data[] = array(
...
$config = array(
    ...
    'maxlength'   => '64',
    'size'        => '60',
	'value'		  => $epacket_config->pickupaddress_contact,
);
$data[] = array(
...
$config = array(
    ...
    'maxlength'   => '128',
    'size'        => '60',
	'value'		  => $epacket_config->pickupaddress_email,
);
$data[] = array(
...
$config = array(
    ...
    'maxlength'   => '32',
    'size'        => '60',
	'value'		  => $epacket_config->pickupaddress_mobile,
);
$data[] = array(
...
$config = array(
    ...
    'maxlength'   => '32',
    'size'        => '60',
	'value'		  => $epacket_config->pickupaddress_phone,
);
$data[] = array(
...
$config = array(
    ...
    'maxlength'   => '6',
    'size'        => '10',
	'value'		  => $epacket_config->pickupaddress_postcode,
);
$data[] = array(
...
$config = array(
    ...
    'maxlength'   => '64',
    'size'        => '60',
	'value'		  => $epacket_config->pickupaddress_country,
);
$data[] = array(
...
$config = array(
    ...
    'maxlength'   => '64',
    'size'        => '60',
	'value'		  => $epacket_config->pickupaddress_province,
);
$data[] = array(
...
$config = array(
    ...
    'maxlength'   => '64',
    'size'        => '60',
	'value'		  => $epacket_config->pickupaddress_city,
);
$data[] = array(
...
$config = array(
    ...
    'maxlength'   => '64',
    'size'        => '60',
	'value'		  => $epacket_config->pickupaddress_district,
);
$data[] = array(
...
$config = array(
    ...
    'maxlength'   => '200',
    'size'        => '60',
	'value'		  => $epacket_config->pickupaddress_street,
);
$data[] = array(
...
$config = array(
    ...
    'maxlength'   => '128',
    'size'        => '60',
	'value'		  => $epacket_config->shipfromaddress_company,
);
$data[] = array(
...
$config = array(
    ...
    'maxlength'   => '64',
    'size'        => '60',
	'value'		  => $epacket_config->shipfromaddress_contact,
);
$data[] = array(
...
$config = array(
    ...
    'maxlength'   => '128',
    'size'        => '60',
	'value'		  => $epacket_config->shipfromaddress_email,
);
$data[] = array(
...
$config = array(
    ...
    'maxlength'   => '32',
    'size'        => '60',
	'value'		  => $epacket_config->shipfromaddress_mobile,
);
$data[] = array(
...
$config = array(
    ...
    'maxlength'   => '6',
    'size'        => '10',
	'value'		  => $epacket_config->shipfromaddress_postcode,
);
$data[] = array(
...
$config = array(
    ...
    'maxlength'   => '64',
    'size'        => '60',
	'value'		  => $epacket_config->shipfromaddress_country,
);
$data[] = array(
...
$config = array(
    ...
    'maxlength'   => '64',
    'size'        => '60',
	'value'		  => $epacket_config->shipfromaddress_province,
);
$data[] = array(
...
$config = array(
    ...
    'maxlength'   => '64',
    'size'        => '60',
	'value'		  => $epacket_config->shipfromaddress_city,
);
$data[] = array(
...
$config = array(
    ...
    'maxlength'   => '64',
    'size'        => '60',
	'value'		  => $epacket_config->shipfromaddress_district,
);
$data[] = array(
...
$config = array(
    ...
    'maxlength'   => '200',
    'size'        => '60',
	'value'		  => $epacket_config->shipfromaddress_street,
);
$data[] = array(
...
$config = array(
    ...
    'maxlength'   => '128',
    'size'        => '60',
	'value'		  => $epacket_config->returntoaddress_company,
);
$data[] = array(
...
$config = array(
    ...
    'maxlength'   => '64',
    'size'        => '60',
	'value'		  => $epacket_config->returntoaddress_contact,
);
$data[] = array(
...
$config = array(
    ...
    'maxlength'   => '6',
    'size'        => '10',
	'value'		  => $epacket_config->returntoaddress_postcode,
);
$data[] = array(
...
$config = array(
    ...
    'maxlength'   => '64',
    'size'        => '60',
	'value'		  => $epacket_config->returntoaddress_country,
);
$data[] = array(
...
$config = array(
    ...
    'maxlength'   => '64',
    'size'        => '60',
	'value'		  => $epacket_config->returntoaddress_province,
);
$data[] = array(
...
$config = array(
    ...
    'maxlength'   => '64',
    'size'        => '60',
	'value'		  => $epacket_config->returntoaddress_city,
);
$data[] = array(
...
$config = array(
    ...
    'maxlength'   => '64',
    'size'        => '60',
	'value'		  => $epacket_config->returntoaddress_district,
);
$data[] = array(
...
$config = array(
    ...
    'maxlength'   => '200',
    'size'        => '60',
	'value'		  => $epacket_config->returntoaddress_street,
);
$data[] = array(
...
$title = lang('edit_epacket_config');
...
echo form_open(site_url('shipping/epacket_config/edit_save'),$attributes);
echo $this->block->generate_table($head, $data);

$url = site_url('shipping/epacket_config/edit_save');
$config = array(
    'name'        => 'submit',
    'value'       => lang('save'),
    'type'        => 'button',
...
echo form_hidden('id', $epacket_config ? $epacket_config->id : '');
